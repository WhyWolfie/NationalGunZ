...
#define MMATCH_DEFAULT_STAGESETTING_CLASSIC	            false	
...
public:
	...
	bool						IsESP()				{ return m_StageSetting.Ref().bESP; } //ESP
	bool						IsNF()				{ return m_StageSetting.Ref().bNF; }
	...
	bool						GetClassic()   			     	{ return m_StageSetting.Ref().bClassic; }
