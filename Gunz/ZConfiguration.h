...
#define ZTOK_EXTRA_DISABLESPECIAL "DISABLESPECIAL"
#define ZTOK_EXTRA_NOMASSIVE      "NOMASSIVE"
#define ZTOK_EXTRA_CHAT           "CHAT"
#define ZTOK_EXTRA_WHISPER        "WHISPER"
#define ZTOK_EXTRA_CLAN           "CLAN"
#define ZTOK_EXTRA_FPS            "FPS"
#define ZTOK_EXTRA_HIDECROSSHAIR  "HIDECROSSHAIR"
#define ZTOK_EXTRA_BULLET         "BULLET"
#define ZTOK_EXTRA_SWORD          "SWORD"
#define ZTOK_EXTRA_HPAP           "HPAP"
#define ZTOK_EXTRA_VISIBLE        "VISIBLE"
#define ZTOK_EXTRA_WHEELLOCK      "WHEELLOCK"
#define ZTOK_EXTRA_NONUMBERS      "NONUMBERS"
#define ZTOK_EXTRA_SCOPS          "SCOPS"
#define ZTOK_EXTRA_NOSMOKE        "NOSMOKE"
#define ZTOK_EXTRA_DAMAGE         "DAMAGE"
#define ZTOK_EXTRA_TIME           "TIME"
#define ZTOK_EXTRA_POSITION       "POSITION"
#define ZTOK_EXTRA_AUTOREC        "AUTOREC"
...
#define Z_EXTRA_DISABLESPECIAL  (ZGetConfiguration()->GetExtra()->bDisableSpecial)
#define Z_EXTRA_DAMAGECOUNTER   (ZGetConfiguration()->GetExtra()->bDamageCounter)
#define Z_EXTRA_NOMASSIVE      	(ZGetConfiguration()->GetExtra()->bnomassive)
#define Z_EXTRA_FPS      	    (ZGetConfiguration()->GetExtra()->bfps)
#define Z_EXTRA_HIDECROSSHAIR   (ZGetConfiguration()->GetExtra()->bhidecrosshair)
#define Z_EXTRA_BULLET      	(ZGetConfiguration()->GetExtra()->bbullet)
#define Z_EXTRA_SWORD        	(ZGetConfiguration()->GetExtra()->bsword)
#define Z_EXTRA_HPAP      	    (ZGetConfiguration()->GetExtra()->bhpap)
#define Z_EXTRA_VISIBLE     	(ZGetConfiguration()->GetExtra()->bvisible)
#define Z_EXTRA_WHEELLOCK     	(ZGetConfiguration()->GetExtra()->bwheellock)
#define Z_EXTRA_NONUMBERS      	(ZGetConfiguration()->GetExtra()->bnonumbers)
#define Z_EXTRA_SCOPS     	    (ZGetConfiguration()->GetExtra()->bscops)
#define Z_EXTRA_NOSMOKE     	(ZGetConfiguration()->GetExtra()->bnosmoke)
#define Z_EXTRA_DAMAGE      	(ZGetConfiguration()->GetExtra()->bdamage)
#define Z_EXTRA_TIME         	(ZGetConfiguration()->GetExtra()->btime)
#define Z_EXTRA_POSITION      	(ZGetConfiguration()->GetExtra()->bposition)
#define Z_EXTRA_AUTOREC         (ZGetConfiguration()->GetExtra()->bautorec)
