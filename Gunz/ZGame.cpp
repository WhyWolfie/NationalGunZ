...
{
sprintf(szName, "!^9My HP: %d, AP: %d",(int)ZGetGame()->m_pMyCharacter->GetHP(),(int)ZGetGame()->m_pMyCharacter->GetAP());
...
//				ZGetGameInterface()->GetBandiCapturer()->ToggleStart();
			...
			{					
				...
				if(ZGetConfiguration()->GetExtra()->bDamageCounter)
				{
					...
					sprintf(szMsg, "I have dealt %i damage and taken %i damage.", ZGetGame()->m_pMyCharacter->GetStatus().Ref().nDamageDealt, ZGetGame()->m_pMyCharacter->GetStatus().Ref().nDamageTaken);
