...
#define STAGESETTING_NF_MAX		2
#define STAGESETTING_NF_DEFAULT	0
static struct _STAGESETTING_NF
{
	bool	Value;
	char	szText[32];
} StageSetting_StageNF[STAGESETTING_NF_MAX] = 
{ {true, "ON"}, {false, "OFF"} };

//ESP
#define STAGESETTING_ESP_MAX		2
#define STAGESETTING_ESP_DEFAULT	0
static struct _STAGESETTING_ESP
{
	bool	Value;
	char	szText[32];
} StageSetting_StageESP[STAGESETTING_ESP_MAX] = 
{ {true, "ON"}, {false, "OFF"} };
...
//Classic mode
#define STAGESETTING_CLASSIC_MAX		2
...
/////////////////////////////////////////////////////////////////////////////////////////////
	//Classic mode 
	BUILD_STAGESETTING_ITEM("classic", pOutNode->bClassic,StageSetting_StageCLASSIC, STAGESETTING_CLASSIC_MAX);
	...
	BUILD_STAGESETTING_ITEM("StageESP", pOutNode->bESP,
							StageSetting_StageESP, STAGESETTING_ESP_MAX); //ESP
	BUILD_STAGESETTING_ITEM("StageNF", pOutNode->bNF,
							StageSetting_StageNF, STAGESETTING_NF_MAX);
	// 관전 허용
...
/////////////////////////////////////////////////////////////////////////////////
	...
	{
		// 최대 인원
		SHOWSTAGESETTING_LISTITEM( "StageMaxPlayer", pStageSetting->nMaxPlayers, pGameTypeCfg->m_MaxPlayers, 99999 );
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	//Classic mode 
	SHOWSTAGESETTING_ITEM("classic", pStageSetting->bClassic,
		STAGESETTING_CLASSIC_MAX, StageSetting_StageCLASSIC);
	...
	SHOWSTAGESETTING_ITEM("StageESP", pStageSetting->bESP, //ESP
		STAGESETTING_ESP_MAX, StageSetting_StageESP);

	SHOWSTAGESETTING_ITEM("StageNF", pStageSetting->bNF,
		STAGESETTING_NF_MAX, StageSetting_StageNF);
...
#define GET_LIMITLEVEL(_value)		sprintf(szText,"%s %d",ZMsg(MSG_WORD_LEVELDIFF),_value);
	...
	//Classic mode
    strcpy( StageSetting_StageCLASSIC[0].szText, ZMsg(MSG_WORD_ON));
	strcpy( StageSetting_StageCLASSIC[1].szText, ZMsg(MSG_WORD_OFF));
	INITSTAGESETTING_ITEM("classic", pStageSetting->bClassic,
	STAGESETTING_CLASSIC_MAX, StageSetting_StageCLASSIC, STAGESETTING_CLASSIC_DEFAULT);
	...
	strcpy( StageSetting_StageESP[0].szText, ZMsg(MSG_WORD_ON)); //ESP
	strcpy( StageSetting_StageESP[1].szText, ZMsg(MSG_WORD_OFF));
	INITSTAGESETTING_ITEM("StageESP", pStageSetting->bESP,
	STAGESETTING_ESP_MAX, StageSetting_StageESP, STAGESETTING_ESP_DEFAULT);

	strcpy( StageSetting_StageNF[0].szText, ZMsg(MSG_WORD_ON));
	strcpy( StageSetting_StageNF[1].szText, ZMsg(MSG_WORD_OFF));
	INITSTAGESETTING_ITEM("StageNF", pStageSetting->bNF,
	STAGESETTING_NF_MAX, StageSetting_StageNF, STAGESETTING_NF_DEFAULT);
