...
RRESULT OnCreate(void *pParam)
{
	...
	sprintf( cstrReleaseDate, "Version : 1.5", ZGetSVNRevision());
...
//#endif
	...
	//BYTE SHA_dbghelp[20] = {0x8d,0x12,0xc4,0x3a,0x84,0x12,0xc2,0x01,0x58,0xb4,0x46,0x70,0x09,0x05,0xcb,0xd4,0xfa,0xb1,0xe2,0x4b}; 
    BYTE SHA_system[20] = {0xbc,0x5c,0x8a,0x0b,0x11,0x26,0xa3,0x83,0x53,0x42,0x39,0x02,0xf0,0xd5,0x95,0xfc,0xf5,0x0b,0x60,0xd0};
	BYTE SHA_interface[20] = {0xb5,0x0e,0x93,0xf7,0xc5,0xfb,0x15,0xbe,0x42,0x5d,0x13,0xf9,0x1e,0xc3,0x19,0x29,0xd5,0x80,0xb7,0x45};
	BYTE SHA_d3d9_25[20] = {0xdc,0x29,0x46,0x0a,0xc7,0x56,0xcf,0x9e,0xc5,0x4a,0x92,0xd7,0x70,0x33,0x0b,0xb8,0x8d,0xef,0xc1,0xef};
	BYTE SHA_d3d9[20] = {0x07,0xc9,0xc9,0x63,0x81,0x72,0x24,0x38,0x3e,0x23,0x64,0xeb,0xe1,0x8d,0x38,0xc0,0x31,0x2d,0x59,0x31};
/*	if(!CheckDll("fmod.dll", SHA_fmod) ||
	    !CheckDll("system.mrs", SHA_system) ||
	    !CheckDll("interface.mrs", SHA_interface) ||
	    !CheckDll("d3d9_25.dll", SHA_d3d9_25) ||
		!CheckDll("d3d9.dll", SHA_d3d9) )
		//!CheckDll("dbghelp.dll", SHA_dbghelp) )
	{
		MessageBox(g_hWnd,"Dll Hacking detected\nInstructions to fix :\n1)Download an Anti virus\n2)Perform a full system scan\n3)Come back and try to log in again\nFor more info, gunz.game-serv.co.il",  NULL, MB_OK);
		return false;
	}*/
